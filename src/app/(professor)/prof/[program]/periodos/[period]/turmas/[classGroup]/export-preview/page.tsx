...
async function ClassGroupExportPreviewPageContent({
    params,
}: PageProps<"/prof/[program]/periodos/[period]/turmas/[classGroup]/export-preview">) {
    ...
    const exportPdfUrl = `/api/prof/${program}/periodos/${period}/turmas/${classGroup}/alunos/export?format=pdf`;
    const backUrl = `/prof/${program}/periodos/${period}/turmas/${classGroup}`;
