...
export function createTeacherColumns(canWrite: boolean): ColumnDef<User>[] {
...
export function useTeacherColumns(): ColumnDef<User>[] {
    const canWrite = useCanWrite();
    return useMemo(() => createTeacherColumns(canWrite), [canWrite]);
}
