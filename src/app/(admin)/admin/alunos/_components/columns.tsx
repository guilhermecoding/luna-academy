...
export function createStudentColumns(canWrite: boolean): ColumnDef<StudentListItem>[] {
    const baseColumns: ColumnDef<StudentListItem>[] = [
        {
            accessorKey: "avatar",
            header: "",
            cell: ({ row }) => {
...
export function useStudentColumns(): ColumnDef<StudentListItem>[] {
    const canWrite = useCanWrite();
    return useMemo(() => createStudentColumns(canWrite), [canWrite]);
}
